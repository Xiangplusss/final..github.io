...
// Click the question button (clicking is prohibited before the animation ends)
...
// Click the back button (switch the view after the animation ends)
const handleBackClick = async () => {
    ...
    // Switch the view after the animation is over
